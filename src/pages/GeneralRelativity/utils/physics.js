 ...
 */
export const calculatePotential = (mass, r, type = 'newtonian', speedOfLight = C) => {
 ...
 */
export const calculateAcceleration = (px, py, pz, massPos, mass, outVector, type = 'newtonian', speedOfLight = C) => {
 ...
 * v = sqrt(r * a)
 */
export const calculateOrbitalVelocity = (mass, r, type = 'newtonian', speedOfLight = C) => {
    if (type === 'newtonian') {
