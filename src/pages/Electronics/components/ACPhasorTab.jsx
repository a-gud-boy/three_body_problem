            ...
            <div className="simulation-area">
                ...
                <div className="visualizer-container">
                    ...
                    <div className="viz-section" ref={waveformContainerRef}>
                        ...
                        <canvas ref={waveformCanvasRef} width={canvasWidth} height={180} className="viz-canvas" role="img" aria-label="Waveform Canvas" />
                    </div>

                    {/* Phasor Section */}
                    <div className="viz-section" ref={phasorContainerRef}>
                        <div className="viz-section-label">Phasor Diagram</div>
                        <canvas ref={phasorCanvasRef} width={canvasWidth} height={200} className="viz-canvas" role="img" aria-label="Phasor Diagram Canvas" />
                    </div>
                    ...
                    <div className="viz-controls">
                        <div className="control-row">
                            <div className="freq-control">
                                <label className="control-label" htmlFor="frequency-input">Frequency</label>
                                <input
                                    id="frequency-input"
                                    type="range"
                                    min="1" max="1000"
