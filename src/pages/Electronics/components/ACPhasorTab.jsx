            ...
            <div className="simulation-area">
                ...
                <div className="visualizer-container">
                    ...
                    <div className="viz-section" ref={waveformContainerRef}>
                        ...
                        <canvas ref={waveformCanvasRef} width={canvasWidth} height={180} className="viz-canvas" role="img" aria-label="Oscilloscope waveform display" />
                    </div>

                    {/* Phasor Section */}
                    <div className="viz-section" ref={phasorContainerRef}>
                        <div className="viz-section-label">Phasor Diagram</div>
                        <canvas ref={phasorCanvasRef} width={canvasWidth} height={200} className="viz-canvas" role="img" aria-label="Phasor diagram display" />
                    </div>
